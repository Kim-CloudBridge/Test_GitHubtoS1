...
variable "mdb_security_group_id" {
  description = "ID of the MDB Security Group"
  type        = string
}
...
variable "db_subnet_ids_array" {
  description = "An array with all the db subnets ids"
  type        = list(string)
}
...
variable "mdb_fsx_security_group_id" {
  description = "ID of the MDB FSX Security Group"
  type        = string
}
variable "common" {
