locals{
  ...
  management_sgp_name = join("-", [var.global_vars.global.naming_convention.product, var.common, join("", [var.client_id, "n"]),
    var.application_name, var.global_vars.global.naming_convention.SECURITY_GROUP
  ])
