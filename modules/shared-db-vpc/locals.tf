locals {
  vpc_tag_name = join("-", [var.global_vars.global.naming_convention.product, var.common, var.client_env,
    var.global_vars.global.naming_convention.SHAREDDB,
  ...
  intra_acl_tags = merge({
    Name : join("-", [
      ...
      var.global_vars.global.naming_convention.SHAREDDB, var.global_vars.global.naming_convention.SPV,
  ...
  tags = merge(var.global_vars.global.tags, {
    ...
    "Component"     = "${var.global_vars.global.tagging_convention.service_tag.LENDSCAPE}-SHARED-DB-VPC",
