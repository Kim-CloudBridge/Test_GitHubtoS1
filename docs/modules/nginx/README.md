...
| Name | Type |
|------|------|
| [aws_instance.nginx_01](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/instance) | resource |
| [aws_instance.nginx_02](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/instance) | resource |
| [aws_lb_target_group_attachment.nginx_target_group_attachment_01](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_target_group_attachment) | resource |
| [aws_lb_target_group_attachment.nginx_target_group_attachment_02](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_target_group_attachment) | resource |
...
| <a name="input_nginx_security_group_id"></a> [nginx\_security\_group\_id](#input\_nginx\_security\_group\_id) | ID of the Nginx Security Group | `string` | n/a | yes |
| <a name="input_public_subnet_ids_array"></a> [public\_subnet\_ids\_array](#input\_public\_subnet\_ids\_array) | An array with all the public subnets ids | `list(string)` | n/a | yes |
